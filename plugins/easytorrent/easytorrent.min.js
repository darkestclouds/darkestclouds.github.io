                                ...
                                Lampa.Input.edit({
                                    ...
                                    if (new_value) {
                                        try {
                                            ...
                                            const preview = new_value.length > 100 ? new_value.substring(0, 100) + '...' : new_value;
                                ...
                                Lampa.Input.edit({
                                    ...
                                    if (base64Value) {
                                        try {
                                            ...
                                            // Показываем что получили
                                            const preview = base64Value.length > 100 ? base64Value.substring(0, 100) + '...' : base64Value;
                                            let decodedPreview = '';
                                            try {
                                                decodedPreview = '\n\nДекодировано:\n' + decodeURIComponent(escape(atob(base64Value))).substring(0, 100) + '...';
                                            } catch (decodeError) {
